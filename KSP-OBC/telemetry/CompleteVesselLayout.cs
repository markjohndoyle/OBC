...
namespace KSP_OBC.telemetry {
    ...
    class CompleteVesselLayout {
        ...
        public static int TOTAL_SIZE_OF_LAYOUT = sizeof(double) * 13 + sizeof(int);
        ...
        public static int ANGV_Y_OFFSET = sizeof(double) + ANGV_X_OFFSET;
        public static int ANGV_Z_OFFSET = sizeof(double) + ANGV_Y_OFFSET;
        public static int ANGM_X_OFFSET = sizeof(double) + ANGV_Z_OFFSET;
        public static int ANGM_Y_OFFSET = sizeof(double) + ANGM_X_OFFSET;
        public static int ANGM_Z_OFFSET = sizeof(double) + ANGM_Y_OFFSET;
        public static int CUR_STAGE_OFFSET = sizeof(double) + CUR_STAGE_OFFSET;
